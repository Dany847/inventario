...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> INICIO</a> <a href="#" class="tip-bottom">FORMULARIO</a> <a href="#" class="current">RESIDUO</a> </div>
    ...
    <div class="span9">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form method = "POST" action = "save/guardar_residuos.php" class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input style="height: 40px" type="text" class="span9" name="clasificacion" required/>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Recipiente :</label>
              <div class="controls">
                <input type="text" class="span9" name="recipiente" required/>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Observación :</label>
              <div class="controls">
                <input style="height: 40px" type="text" class="span9" name="observaciones" required/>
              </div>
            </div>
            <div class="control-group">
            ...
            <div class="form-actions">
              <button type="submit" name = "guardar_residuos" class="btn btn-success">GUARDAR</button>
            </div>
          </form>
        </div>
      </div>
