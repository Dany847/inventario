...
<body>
  ...
  <div id="content">
    ...
    <div class="container-fluid">
      ...
      <div class="row-fluid">
        <div class="span12">
           <a href="usuarios.php"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-plus-square" viewBox="0 0 16 16">
          ...
          <div class="widget-box">
            ...
            <div class="widget-content nopadding">
              <table class="table table-bordered data-table">
                ...
                <tbody>
                  <?php
                  $quasuario = $conn->query("SELECT * FROM `usuarios`") or die(mysqli_error());
                  $count = 0;
                  while($fila = $quasuario->fetch_array()){
                   ...
                   <tr>
                    ...
                    <td style="text-align: center; width: 200px;" >
                      ...
                      &nbsp; &nbsp; &nbsp;
                      <?php echo "<a href='actualizar_usuario.php?idusuario=".$fila['idusuario']."'> <img src='img/boton-editar.png'  width='20' height='20' border=0/> </a>"; ?>
                    </td>
                  </tr>
                  <?php
                }
...
<script type="text/javascript">
  function preguntar(idusuario){
    ...
    {
      window.location.href = "delete/eliminar_usuarios.php?del=" + idusuario;
    }
