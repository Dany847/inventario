<?php
	...
	require 'connect.php';
	 ...
	 $consulta = $conn->query("select p.idprestamo, p.f_prestado, p.cantidad, p.estado, m.descripcion, u.nombre, u.apellidos
	 	from prestamo p
	...
	$pdf->Cell(200,6, utf8_decode('INVENTARIO DE PRÉSTAMO'),0,0,'C' );
	$pdf->Ln(10);
	$pdf->SetFillColor(255,255,255);
	$pdf->SetFont('Arial','B',12);
	...
	$pdf->SetFillColor(255,255,255);
	$pdf->SetFont('Arial','B',12);
	$pdf->Cell(35,6, utf8_decode('Periodo: '),0,0,'C' );
	$pdf->Ln(10);
	$pdf->SetFillColor(255,255,255);
	$pdf->SetFont('Arial','B',12);
	...
	$pdf->SetFillColor(255,255,255);
	$pdf->SetFont('Arial','B',12);
	$pdf->Cell(200,6, utf8_decode('Federico Francisco Martínez'),0,0,'C' );
	$pdf->Output();
?>