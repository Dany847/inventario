...
$quey = $conn->query("SELECT * FROM `materiales` WHERE `idmaterial` = '$_REQUEST[idmaterial]'") or die(mysqli_error());
...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> INICIO</a> <a href="#" class="tip-bottom">FORMULARIO</a> <a href="#" class="current">MATERIALES</a> </div>
  <h1>ACTUALIZAR MATERIALE</h1>
</div>
    ...
    <div class="span9">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form method = "POST" action = "edit/edit_material.php?idmaterial=<?php echo $fila['idmaterial']?>" class="form-horizontal">
            ...
            <div class="form-actions">
              <button type="submit" name = "edit_material" class="btn btn-success">ACTUALIZAR</button>
            </div>
          </form>
        </div>
      </div>
