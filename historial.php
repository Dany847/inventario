...
<body>
  ...
  <div id="content">
    <div id="content-header">
      ...
      <h1>HISTORIAL DE PRÉSTAMO DE MATERIALES</h1>
    </div>
    <div class="container-fluid">
      ...
      <div class="row-fluid">
        <div class="span12">
          ...
          <a href="pdf_historial.php" target="_blank" class="btn btn-success btn-sm">Generar pdf</a>
          <div class="widget-box">
            ...
            <div class="widget-content nopadding">
              <table class="table table-bordered data-table">
                ...
                <tbody>
                 <?php
                 $qregreso = $conn->query("SELECT * FROM `historial` ORDER BY idhistorial desc") or die(mysqli_error());
...
<script type="text/javascript">
  function preguntar(idhistorial){
    if(confirm('¿Estas seguro que quieres elimarlo?'))
    {
      window.location.href = "delete/eliminar_historial.php?del=" + idhistorial;
    }
