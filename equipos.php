    ...
    <div class="span9">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form method = "POST" action = "save/guardar_equipos.php" class="form-horizontal">
            <div class="control-group">
              <label class="control-label">N° de serie :</label>
              <div class="controls">
                <input style="height: 40px" type="text" class="span9" name="n_serie" required/>
              </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input style="height: 40px" type="text" class="span9" name="modelo" required/>
              </div>
            </div>
            <div class="control-group">
            ...
            <div class="form-actions">
              <button type="submit" name = "save_equipo" class="btn btn-success">GUARDAR</button>
            </div>
          </form>
        </div>
      </div>
