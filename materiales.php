...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> INICIO</a> <a href="#" class="tip-bottom">FORMULARIO</a> <a href="#" class="current">MATERIAL</a> </div>
    ...
    <div class="span9">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form method = "POST" action = "save/guardar_materiales.php" class="form-horizontal">
            ...
            <div class="form-actions">
              <button type="submit" name = "guardar_materiales" class="btn btn-success">GUARDAR</button>
            </div>
          </form>
        </div>
      </div>
