<?php
	...
	require 'connect.php';
	 $consulta = $conn->query("select * from residuos  where idarea = '4'
	  ") or die(mysqli_error());
	$pdf = new PDF();
	$pdf->AliasNbPages();
	$pdf->AddPage();
	...
	$pdf->SetFillColor(255,255,255);
	$pdf->SetFont('Arial','B',12);
	$pdf->Cell(230,6, utf8_decode('LABORATORIO DE MICROBIOLOGÍA'),0,0,'C' );
	$pdf->Ln(10);
	$pdf->SetFillColor(255,255,255);
	...
	$pdf->SetFillColor(255,255,255);
	$pdf->SetFont('Arial','',12);
	$pdf->Cell(185,6, utf8_decode('Ing. Viridiana Hernández Martínez'),0,0,'C' );
	$pdf->Ln(5);
	$pdf->SetFillColor(255,255,255);
	$pdf->SetFont('Arial','',12);
